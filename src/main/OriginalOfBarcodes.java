...
public class OriginalOfBarcodes {
 
    /** The resulting PDF. */
    private static final String RESULT = "/eclipseEE/pleiades/workspaceRobotAndTimmer/PassForBarcord/barcodes.pdf";
    ...
    public static void main(String[] args) throws IOException,
            DocumentException {
        new OriginalOfBarcodes().createPdf(RESULT);
    }
